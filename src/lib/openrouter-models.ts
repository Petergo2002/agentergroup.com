...
const CURATED_MODEL_DEFINITIONS: CuratedModelDefinition[] = [
  ...
  },
  {
    ...
    summary: 'Open-weight frontier model for advanced reasoning, coding, and long-horizon agent workflows.',
    section: 'open',
    badge: 'Open',
    contextLength: 1_048_576,
    pricing: { prompt: '0.435', completion: '0.87' },
    tags: ['Open-weight', 'Reasoning', '1M context'],
    latest: true,
  },
  {
    id: 'qwen/qwen3-coder',
