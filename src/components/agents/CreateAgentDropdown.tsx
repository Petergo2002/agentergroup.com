  ...
  return (
    <div className="relative inline-flex text-left" ref={dropdownRef}>
      <button
        ...
        className={`group inline-flex items-center justify-center gap-2 transition-colors duration-150 ${triggerVariantClass} ${buttonClassName ?? ''}`}
      >
        {creatingSurface ? (
      ...
      {isMenuRendered ? (
        <div
          ...
          } top-full z-[80] mt-2 w-[min(20.5rem,calc(100vw-2rem))] overflow-hidden rounded-2xl border border-outline-variant/25 bg-surface-container-lowest shadow-[0_16px_40px_-18px_rgba(15,23,42,0.3)] ${
          ...
          {activeStep === 'menu' ? (
              ...
              <div className="space-y-0.5 p-1.5">
                {surfaceOptions.map((option) => (
                  <button
                    ...
                    className="group flex w-full items-center gap-2.5 rounded-xl border border-transparent px-2.5 py-2 text-left transition-colors duration-150 hover:border-outline-variant/20 hover:bg-surface-container-low active:bg-surface-container disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="mt-0.5 line-clamp-1 text-[11px] leading-4 text-on-surface-variant/70">
                        {option.description}
                      </p>
                    </div>
                    <ChevronRight
            ...
            <>
              ...
              <div className="space-y-3 p-3.5">
                {selectedOption ? (
                  <div className="flex items-center gap-2.5 rounded-xl border border-primary/15 bg-primary/[0.06] px-2.5 py-2">
              ...
              <div className="flex items-center justify-end gap-2 border-t border-outline-variant/15 bg-surface-container-low/45 px-3.5 py-2.5">
                <button
                  type="button"
