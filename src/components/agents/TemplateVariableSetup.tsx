    ...
    <div className="flex flex-col" style={{ animation: "setupSlideIn 0.22s cubic-bezier(0.16,1,0.3,1) both" }}>
      ...
      <div className="mt-8">
        <button
          ...
          className="relative flex h-12 w-full items-center justify-center gap-2 overflow-hidden rounded-2xl bg-on-surface text-xs font-bold uppercase tracking-[0.16em] text-background transition-all hover:opacity-90 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-40"
        >
          {isImporting ? (
            <>
