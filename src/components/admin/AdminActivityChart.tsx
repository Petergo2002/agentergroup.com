...
export function AdminActivityChart({ points }: AdminActivityChartProps) {
      ...
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="text-right">
          ...
          <p className="mt-1 text-sm text-neutral-200">
            {formatAdminNumber(totalMessages)} messages
          </p>
        </div>
      </div>
            ...
            <div key={point.dateKey} className="flex min-w-0 flex-1 flex-col items-center gap-2">
              <div className="flex h-52 w-full items-end rounded-t-xl bg-[#121212] px-1">
                <div
                  ...
                  style={{ height }}
                  title={`${point.label}: ${formatAdminNumber(point.messageCount)} messages`}
                />
              </div>
