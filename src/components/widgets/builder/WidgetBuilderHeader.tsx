          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            {isDeployed && needsRedeploy && (
              <button
                ...
                className="app-primary-surface group relative flex items-center gap-2 overflow-hidden rounded-md px-6 py-2.5 text-xs font-bold uppercase tracking-[0.16em] transition-all duration-150 hover:scale-[1.02] active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:opacity-50"
              >
