export const connections = {
  ...
  title: "Anslutningar",
  description:
    "Anslut Gmail, Outlook, Slack, HubSpot, Shopify, Google Calendar, Cal.com och Google Drive. Chattintegrationer driver liveåtgärder för agenter, medan Drive används för kunskapsimporter.",
