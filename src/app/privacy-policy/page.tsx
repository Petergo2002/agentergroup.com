...
const sections = [
  ...
  },
  {
    ...
    body: [
      ...
      "These providers may process personal data on our behalf to the extent necessary to deliver the service. Additional providers may be used over time as the product evolves. See the public subprocessors page for the current provider list and links.",
    ],
  },
  {
      ...
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-10 px-6 py-16 sm:px-8 sm:py-20">
        <div className="rounded-[28px] border border-outline-variant/20 bg-white/90 p-8 shadow-sm shadow-slate-200/60 sm:p-10">
          ...
          <p className="mt-4 max-w-2xl text-sm leading-7 text-on-surface-variant sm:text-base">
            This page is public and does not require sign-in. It is intended to
            be linked from Agentergroup-powered widgets and related product
            surfaces so website visitors can understand how data may be
            processed.
          </p>
